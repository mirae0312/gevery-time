 ...
 */
@WebServlet("/customer/qnaBoardList")
...
//		List<QnaBoard> list = qnaBoardService.selectAllQnaBoard(param);
		...
		//pagebar영역 : MvcUtils.getPagebar 호출
		//totalContent
		int totalContent = qnaBoardService.selectTotalQnaBoardCount();
		...
		request
			.getRequestDispatcher("/WEB-INF/views/customer/qnaBoardList.jsp")
